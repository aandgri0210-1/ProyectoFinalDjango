...
urlpatterns = [
    ...
    path("personajes/<int:personaje_id>/inventario/objeto/<int:inventario_item_id>/", views.detalle_objeto_inventario, name="inventario-objeto-detalle"),
    ...
    path("personajes/<int:personaje_id>/inventario/equipamiento/", views.toggle_equipamiento_inventario, name="inventario-equipamiento"),
